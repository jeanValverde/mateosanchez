<?php
	...
	if($is_fail == 0 && $is_test == 0){
		...
		$inserta -> bindValue(':param_01', $_SESSION["id_cuenta"]);
		$inserta -> bindValue(':param_02', $id_receptor);
		$inserta -> bindValue(':param_03', utf8_decode($detalle_mensaje));
		$inserta -> bindValue(':param_04', utf8_decode($nombre_cliente));
		$inserta -> bindValue(':param_05', utf8_decode($telefono_cliente));
		$inserta -> bindValue(':param_06', utf8_decode($correo_cliente));
		$inserta -> bindValue(':param_07', utf8_decode($codigo_propiedad_cliente));
