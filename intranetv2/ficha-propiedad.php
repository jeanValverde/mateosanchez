                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 content" id="content">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="owl-carousel img-carousel">
                                                <div class="item">
                                                    <a href="assets/img/preview/property/cat1-70x70x1.jpg" data-gal="prettyPhoto">
														<img class="img-responsive" src="../img/propiedades/<?php echo $propiedad["img_01_propiedad"];?>" alt=""/>
														<!--
														<?php
								...
								<div class="visible-print-block">
									<div class="col-xs-2 col-sm-2 col-md-3"><img src="../img/propiedades/<?php echo $propiedad["img_01_propiedad"];?>" alt=""/></div>
                                    <div class="col-xs-2 col-sm-2 col-md-3"><img src="../img/propiedades/<?php echo $propiedad["img_02_propiedad"];?>" alt=""/></div>
                                    <div class="col-xs-2 col-sm-2 col-md-3"><img src="../img/propiedades/<?php echo $propiedad["img_03_propiedad"];?>" alt=""/></div>
                                    <div class="col-xs-2 col-sm-2 col-md-3"><img src="../img/propiedades/<?php echo $propiedad["img_04_propiedad"];?>" alt=""/></div>
								</div>
                                ...
                                <h3 class="block-title alt"><i class="fa fa-angle-down"></i>Informaci&oacute;n - <?php echo $propiedad["nombre_tipo_propiedad"]; ?> - <?php echo $propiedad["nombre_comuna"]; ?> - Visitas sitio: <?php echo $propiedad["cantidad_visitas_propiedad"]; ?></h3>
								<div class="widget shadow widget-details-reservation">
                                    <h4 class="widget-title"><?php echo $propiedad["nombre_tipo_operacion"];?></h4>
                                            ...
                                            <div class="list">
												...
												<?php
													if($propiedad["id_tipo_valor"] == 1){
														...
														$precio_ajustado = round($propiedad["valor_propiedad"] * $valor_uf);
														echo $propiedad["valor_propiedad"]." UF - ($".number_format($precio_ajustado,0,",",".").")";
													}
