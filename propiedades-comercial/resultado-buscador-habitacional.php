...
<body>
    ...
    <header id="banner" class="stat_bann">
        <img style="width: 100%" src="images/habitacional.jpg">
    </header>
            ...
            <div class="row">
				...
				if($total_registros != 0){
					...
					<div class="titl_sec">
	                    <div class="col-xs-12">
	                        <h3 class="main_titl text-left">
								Resultados Buscador Habitacional
							</h3>
	                    </div>
	                    <div class="clearfix"></div>
	                </div>
					...
					<div class="col-md-6 pt-30">
						...
						<div class="row">
							<div class="col-md-6 text-center">
								<a href="ficha-propiedad-habitacional.php?cod_propiedad=<?php echo $propiedad["codigo_propiedad"]; ?>"><img class="img-propiedad" class="img-responsive img-hover" src="../propiedades/<?php echo $propiedad["img_01_propiedad"]; ?>" alt=""></a>
							</div>
							<div class="col-md-6">
