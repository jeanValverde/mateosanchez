<?php
	...
	$sql_propiedad .= " propiedades.is_hidden = 0 AND id_tipo_giro = 2  ORDER BY propiedades.fecha_captacion_propiedad DESC";
    ...
    <section id="feat_propty">
        <div class="container">
            <div class="row">
				...
				<div id="slide_grupos_propiedades" class="flexslider">
					<ul class="slides">
						<?php
								...
								<div class="panel panel-default" style="padding: 20px;">
									<div class="panel-body">
										<div class="col-md-12 titulo-propiedad">
											<h5 class=" pull-left"> <?php echo $grupo["titulo_grupo_propiedad"]; ?> </h5>
					...
					<div class="col-md-6 pt-30">
						<div class="row">
							<div class="col-md-6 text-center">
								<a href="ficha-propiedad.php?cod_propiedad=<?php echo $propiedad["cod_propiedad"]; ?>"><img class="img-propiedad" class="img-responsive img-hover" src="../propiedades/<?php echo $propiedad["img_01_propiedad"]; ?>" alt=""></a>
							</div>
							<div class="col-md-6">
								...
								<a href="ficha-propiedad.php?cod_propiedad=<?php echo $propiedad["cod_propiedad"]; ?>" style="color: #000;">Ver Detalles</a>
							</div>
						</div>
					</div>
					<?php
