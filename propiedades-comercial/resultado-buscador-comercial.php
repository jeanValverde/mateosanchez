<?php
	...
	$sql_propiedad.=  " INNER JOIN tipo_documentos ON propiedades.cod_propiedad";
	...
	if(isset($_GET["query"])){
		...
		foreach ($array as $query) {
			...
			$sql_propiedad .= " OR tipo_propiedades.id_tipo_propiedad LIKE '%".$query."%'";
...
<body>
    ...
    <header id="banner" class="stat_bann">
        <img style="width: 100%" src="images/comercial1.jpg">
    </header>
					...
					<div class="col-md-6 pt-30">
						...
						<div class="row">
							<div class="col-md-6 text-center">
								<a href="ficha-propiedad-comercial.php?cod_propiedad=<?php echo $propiedad["codigo_propiedad"]; ?>"><img class="img-propiedad" class="img-responsive img-hover" src="../propiedades/<?php echo $propiedad["img_01_propiedad"]; ?>" alt=""></a>
							</div>
							<div class="col-md-6">
								...
								<a href="ficha-propiedad-comercial.php?cod_propiedad=<?php echo $propiedad["codigo_propiedad"]; ?>"  <button class="btn btn-success btn-lg" style="font-size: 13px;" style="color: #;">Ver Detalles</button> </a>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
