								...
								<form id="form-notepad" action="guardar_mensaje.php" method="POST">
								  ...
								  <div class="form-group col-md-6">
									...
									<div class="col-lg-2">
										<div class="form-group">
											<label>
												Publicidad en terreno <input type="checkbox" name="publicidad_terreno_mensaje" value="1">
											</label>
										</div>
									</div>
									...
									<div class="col-lg-2">
										<div class="form-group">
											<label>
												Llamado Telef&oacute;nico <input type="checkbox" name="llamado_telefonico" value="1">
											</label>
										</div>
									</div>
