								...
								<form method="post" action="cerrar_mensajes_grupal.php">
									...
									<?php	
										...
										<!-- /Car Listing -->
											...
											<tr <?php if($mensaje["is_reeded"] == 0){echo "class='not-reeded'";}?> <?php if($mensaje["id_estado_mensaje"] == 1){echo "style='background-color: #FE3200;'";}elseif($mensaje["id_estado_mensaje"] == 2){echo "style='background-color: #FFC652;'";}else{echo "style='background-color: #00A900;'";}?>>
												...
												<td><?php $detalle_mensaje = $mensaje["detalle_mensaje"]; echo substr($detalle_mensaje, 0, 100)."...";?></td>
									...
									<div class="col-md-12">
										<div class="row">
											...
											<button type="submit" class="btn btn-danger">Eliminar nota(s)</button>
											<?php } ?>
										</div>
									</div>
								</form>
