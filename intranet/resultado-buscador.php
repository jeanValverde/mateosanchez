<?php
	...
	*/
	...
	}elseif(isset($_GET["id_comuna"]) && !empty($_GET["id_comuna"]) && $_GET["id_comuna"] != "-"){
		$sql_propiedad .= " AND propiedades.id_comuna = ".$_GET["id_comuna"];
	}elseif(isset($_GET["id_region"]) && !empty($_GET["id_region"]) && $_GET["id_region"] != "-"){
								...
								if($total_registros != 0){
									...
									<div class="thumbnail no-border no-padding thumbnail-property-card clearfix">
										<div class="media col-md-3">
											<a class="media-link" data-gal="prettyPhoto" href="../propiedades/<?php echo $propiedad["img_01_propiedad"];?>">
                                                <img src="../propiedades/<?php echo $propiedad["img_01_propiedad"];?>" alt=""/>
												<?php
										...
										<div class="caption col-md-9">
											...
											<?php
												if($_GET["id_tipo_valor"] == 1){
													$valor_propiedad = round($propiedad["valor_propiedad_ajustado"]);
													echo "$".number_format($valor_propiedad,0,",",".");
												}else{
													echo number_format($propiedad["valor_propiedad_ajustado"],2,",",".")." UF";
												}
											?>
											</h5>
