						...
						<div class="panel-body">
							<div class="dataTable_wrapper">
								<table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									<tbody>
										<?php
										$sql_propiedad = "SELECT * FROM grupos_propiedades ORDER BY titulo_grupo_propiedad";
										...
										<tr>
											...
											<td style="width: 20%;">
												<a href="editar-grupo-propiedades.php?id_grupo_propiedad=<?php echo $propiedad["id_grupo_propiedad"]; ?>" class="btn btn-warning">Editar</a>
												<a href="../php/quitar_grupo_propiedades.php?id_grupo_propiedad=<?php echo $propiedad["id_grupo_propiedad"]; ?>" class="btn btn-danger validar_accion">Quitar</a>
											</td>
										</tr>
										<?php
										}
