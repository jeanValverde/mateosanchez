...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Editar grupo de propiedades</h1>
                </div>
            </div>
			<div class="row">
				<div class="col-lg-12">
						...
						<div class="panel-body">
							<div class="row">
								...
								if(isset($_GET["id_grupo_propiedad"]) && !empty($_GET["id_grupo_propiedad"])){
									...
									$sql_grupo = "SELECT * FROM grupos_propiedades WHERE id_grupo_propiedad = '".$id_grupo_propiedad."'";
									...
									if($validar_grupo == 1){
										...
										?>
										<form role="form" action="../php/editar_grupo_propiedades.php" method="post" id="editar-grupo-propiedades" enctype="multipart/form-data">
											...
											<?php
												...
												if($validar_propiedad > 0){
													...
													while($propiedad = $cursor_propiedad -> fetch()){
														?>
														<div class="col-lg-2">
															<a target="_blank" href="../../propiedades-comercial/ficha-propiedad.php?cod_propiedad=<?php echo $propiedad["cod_propiedad"]; ?>" class="btn btn-default"><?php echo $propiedad["cod_propiedad"]; ?></a>
															<a href="../php/soltar_propiedad_grupo.php?id_grupo_propiedad=<?php echo $grupo["id_grupo_propiedad"]; ?>&cod_propiedad=<?php echo $propiedad["cod_propiedad"]; ?>" class="btn btn-danger" onclick="return confirm('Esta seguro?');">X</a>
														</div>
														<?php
													}
												}
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
										...
										<tr>
											...
											<td><a href="../php/anexar_propiedad_grupo_propiedad.php?id_grupo_propiedad=<?php echo $grupo["id_grupo_propiedad"]; ?>&cod_propiedad=<?php echo $propiedad["cod_propiedad"]; ?>">Anexar al grupo</a></td>
                                        </tr>
										<?php
										}
										?>
