                            ...
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
										...
										$sql_propiedad .= "INNER JOIN documento_visita_propiedades ON documento_visita_propiedades.cod_propiedad = propiedades.cod_propiedad ";
										$sql_propiedad .= "INNER JOIN cuentas ON propiedades.id_cuenta = cuentas.id_cuenta ";
										$sql_propiedad .= "WHERE is_hidden = 0 AND documento_visita_propiedades.is_close_documento_visita_propiedad = 0 ";
										...
										<tr>
                                            ...
                                            <td class="center">
												<a href="../php/generar_copia_documento_visita.php?id_documento=<?php echo $propiedad["id_documento_visita_propiedad"];?>" class="btn btn-warning btn-xs btn-activar" target="_blank">Generar copia</a>
												<a href="generar-reporte-visita.php?id_documento=<?php echo $propiedad["id_documento_visita_propiedad"];?>" class="btn btn-danger btn-xs">Cerrar proceso</a>
											</td>
                                        </tr>
										<?php
										}
