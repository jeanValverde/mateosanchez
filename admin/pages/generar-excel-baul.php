            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <form method="get" action="../php/generar_excel_baul.php" target="_blank">
								...
								<div class="row">
									<div class="col-lg-12">
										...
										<div class="row">
													...
													<select class="form-control" id="id_tipo_propiedad" name="id_tipo_propiedad">
														<?php
															...
															while ($tipo_propiedad = $cursor_tipo_propiedad->fetch()){
																$sql_validar = "SELECT * FROM baul_propiedades WHERE is_hidden=0 AND id_tipo_propiedad=".$tipo_propiedad["id_tipo_propiedad"];
													...
													<select class="form-control" id="id_region" name="id_region">
														<?php
															...
															while ($region = $cursor_region->fetch()){
																$sql_validar = "SELECT * FROM baul_propiedades WHERE is_hidden=0 AND id_region=".$region["id_region"];
																$cursor_validar = $conexion -> query($sql_validar);
																if(!$validar=$cursor_validar->rowCount()){
																	$validar = 0;
																}
											...
											<div class="col-lg-6">
												<div class="form-group">
													<label>Con informaci&oacute;n del propietario?</label>
	...
	<script>
		$(document).ready(function(){
			$("#id_comuna").change(function(){
				$.post("../php/selector_sector_buscador_baul.php",{ id:$(this).val() },function(data){$("#id_sector").html(data);})
			});
		})
		
		$(document).ready(function(){
			$("#id_region").change(function(){
				$.post("../php/selector_comuna_buscador_baul.php",{ id:$(this).val() },function(data){$("#id_comuna").html(data);})
			});
		})
	</script>
