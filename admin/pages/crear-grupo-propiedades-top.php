...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Crear grupo de propiedades Top</h1>
                </div>
            </div>

			<form role="form" action="../php/crear_grupo_propiedades_top.php" method="post" id="crear-grupo-propiedades" enctype="multipart/form-data">
				<div class="row">
					<div class="col-lg-12">
						<?php
								...
								<div class="row">
									<div class="col-lg-12">
										<form role="form" action="../php/crear_grupo_propiedades_top.php" method="post" id="crear-grupo-propiedades" enctype="multipart/form-data">
											...
											<div class="form-group">
												<label>Detalle de la propiedad Top:</label>
												<textarea class="form-control" name="detalle_grupo_propiedad" id="detalle_grupo_propiedad" rows="4"></textarea>
											</div>
											<button type="submit" class="btn btn-default">Agregar Grupo Top</button>
										</form>
									</div>
								</div>
							</div>
