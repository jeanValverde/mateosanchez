<?php
	...
	$html .= "<body style='background-image: url(../../images/bg-pdf-opacity.png); background-repeat: no-repeat; background-position: 45% 45%;'>";
		...
		$html .= "<h1>Contrato Venta Habitacional c&oacute;digo: ".$_GET["cod_propiedad"]."</h1>";
			...
			$html .= "<tbody>";
				...
				$html .= "<tr>";
					$html .= "<td style='text-align: justify;'>";
						$html .= "De concretarse en definitiva la venta de esta <b>propiedad habitacional,</b> a trav&eacute;s de esta oficina de corretaje el cliente pagar&aacute; un honorario equivalente al ".$_GET["porcentaje_tipo_documento"]."% del valor de la compraventa, m&aacute;s el impuesto respectivo. Sin perjuicio de lo anterior se establece que el honorario de corretaje de propiedades para cualquier tipo de operaci&oacute;n de compraventa ser&aacute; m&iacute;nimo de UF22 m&aacute;s impuesto.";
					$html .= "</td>";
				$html .= "</tr>";
		...
		$html .= "<table style='width: 100%'>";
			$html .= "<tbody>";
				$html .= "<tr>";
					$html .= "<td>";
						$html .= "<p><b>BARBARA SYBELLA MARCOLETA</b></p><p><b>SILVA PROPIEDADES E.I.R.L</b></p><p><b>Rut N&deg; 76.190.666-6</b></p>";
					$html .= "</td>";
					
					$html .= "<td>";
						$html .= "<p><b>Nombre: </b></p><p><b>Rut: </b></p>";
					$html .= "</td>";
				$html .= "</tr>";
				
				//$html .= "<tr>";
				//	$html .= "<td>";
				//		$html .= "<p><b>SILVA PROPIEDADES E.I.R.L</b></p><p><b>Rut N&deg; 76.190.666-6</b></p>";
				//	$html .= "</td>";
				//	
				//	$html .= "<td>";
				//		$html .= "<b>Rut: </b>";
	...
	$mpdf->Output('ORDEN VENTA RESIDENCIAL COD'.$_GET["cod_propiedad"].'.pdf','I');
	//==============================================================
	//==============================================================
	//==============================================================
