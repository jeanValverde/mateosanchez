<?php
	...
	$html .= "<body style='background-image: url(../../images/bg-pdf-opacity.png); background-repeat: no-repeat; background-position: 45% 45%;'>";
		...
		$html .= "<h1>Contrato Arriendo Comercial c&oacute;digo: ".$_GET["cod_propiedad"]."</h1>";
			...
			$html .= "<tbody>";
				...
				$html .= "<tr>";
					$html .= "<td style='text-align: justify;'>";
						$html .= "De concretarse en definitiva el arriendo de esta <b>propiedad comercial,</b> a trav&eacute;s de esta oficina de corretaje el cliente pagar&aacute; un honorario equivalente al ".$_GET["porcentaje_tipo_documento"]."% del valor del arriendo, m&aacute;s el impuesto respectivo.";
					$html .= "</td>";
				$html .= "</tr>";
