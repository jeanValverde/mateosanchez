<?php
	...
	if( (isset($_POST["nombre_contacto"])) && (isset($_POST["mensaje_contacto"])) && (isset($_POST["correo_contacto"])) && (isset($_POST["apellido_contacto"])) && (isset($_POST["telefono_contacto"]))){
		...
		//Se valida si el apellido no este vacio
		if(empty($_POST["apellido_contacto"])){
			$_SESSION["mensaje-sistema"] = "Faltan datos en el formulario, favor intentar de nuevo.";
			header("location: contacto.php");
		}else{
		...
		//Se valida si el telefono no este vacio
		...
		$message .= "Enviado por: ".$nombre_contacto." ".$apellido_contacto.", Fono: ".$telefono_contacto.".";
		...
		try {
			...
			$mail->FromName = $nombre_contacto." ".$apellido_contacto;
			...
			$mail->addReplyTo("info@mateosanchez.cl", "Mateo Sanchez Propiedades");		//Add recipient original: "info@mateosanchez.cl", "Mateo Sanchez Propiedades"
	...
	header("location: ../../propiedades-comercial/contacto.php");
?>