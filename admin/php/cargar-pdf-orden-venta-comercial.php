<?php
	...
	$html .= "<body style='background-image: url(../../images/bg-pdf-opacity.png); background-repeat: no-repeat; background-position: 45% 45%;'>";
		...
		$html .= "<h1>Contrato Venta Comercial c&oacute;digo: ".$_GET["cod_propiedad"]."</h1>";
	...
	$mpdf->Output('ORDEN VENTA COMERCIAL COD'.$_GET["cod_propiedad"].'.pdf','I');
	//==============================================================
	//==============================================================
	//==============================================================
