<?php
	...
	if(isset($_POST["adhesivo_efecto_espejo_vertical"]) && $_POST["adhesivo_efecto_espejo_vertical"] == 1){
		...
		if(isset($_POST["adhesivo_efecto_espejo_vertical_mediano"]) && !empty($_POST["adhesivo_efecto_espejo_vertical_mediano"]) && $_POST["adhesivo_efecto_espejo_vertical_mediano"] > 0){
		...
		if(isset($_POST["adhesivo_efecto_espejo_vertical_grande"]) && !empty($_POST["adhesivo_efecto_espejo_vertical_grande"]) && $_POST["adhesivo_efecto_espejo_vertical_grande"] > 0){
	...
	header("location: ../pages/enviar-peticion.php");
?>